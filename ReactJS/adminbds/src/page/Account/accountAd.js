...
function Account() {
    ...
    const loadTinBDS = async () => {
        const result = await axios.get('http://localhost:3001/account/adminmoderator');
        ...
        <div className={styles.box}>
            <div className={styles.contentTin}>
                ...
                <div className={styles.btnAdd}>
                    ...
                    <div>
                        {/* <Link className="btn btn-info" style={{ color: "white" }} to="/batdongsan/add"><AddOutlinedIcon /><AddAccount /></Link> */}
                        <AddAccount />
                    </div>
                </div>
                    ...
                    <tbody>
                        {
                            account.filter((item)=>{
                                ...
                                <tr key={index}>
                                    <td>{index + 1}</td>
                                    <td><img src={`http://localhost:3001/${account.avatar}`} alt="Avatar" className={styles.avatar} /></td>
