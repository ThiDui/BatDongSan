...
import HandellAddLh from './AddLienhe';
import axios from 'axios';
import { Form, FormControl, InputGroup, Button, Row, Col, ListGroup ,Collapse} from 'react-bootstrap';
...
function AddTinBDS() {
    ...
    const [formValues, setFormValue] = useState({
        ...
        BDS_DiaChiCuThe: "", BDS_TrangThai: "Chưa duyệt", UserId: user.id, LoaiTienTeLTTMa: "",
        LoaiGiaoDichLGDMa: "", LoaiBDLMa: "",  XaPhuongXPMa: "", PL_Ten: "",
...
// console.log("dcct",diachi + "," +  formValues.BDS_DiaChiCuThe)
    // const handleXaPhuong =(e)=>{
    //     console.loge.target.value;
    // }
    // let idmaqh=id.slice(0,id.indexOf('_'));
// console.log("MAXA",formValues.XaPhuongXPMa.slice(0,formValues.XaPhuongXPMa.indexOf('_')));
    const handleSubmit = (e) => {
        ...
        axios.post("http://localhost:3001/batdongsan/createus",formData, {
...
//   console.log(formatCash(123500000));
                                ...
                                <div className={styles.form}>
                                    ...
                                    <div className={styles.GrAddress}>
                                        <div className={styles.boxGia}>
                                            <Form.Group>
                                                <Form.Label className={styles.label}>Mức giá (lưu ý: 1 = 1000) <span className={styles.ic}>*</span> </Form.Label>
                                    ...
                                    <p>{formatCash(formValues.BDS_Gia)}</p>
                                    {/* pháp lý */}
                                    <Form.Group>
                                                    ...
                                                    <div className={styles.GrAddress}>
                                                        <div className={styles.tinhthanh}>
                                                            ...
                                                            <Form.Group>
                                                                ...
                                                                <FormControl placeholder="Tên liên hệ" name="LH_Email" value={formValues.LH_Email}  onChange={handleChange} />
                                                            </Form.Group>
                                                        </div>
                                                        <div className={styles.quanhuyen}>
                                                            <Form.Group>
                                                                <Form.Label className={styles.label}>Địa chỉ<span className={styles.ic}>*</span> </Form.Label>
                                                                <FormControl placeholder="Số điện thoại" name="LH_DiaChi" value={formValues.LH_DiaChi} onChange={handleChange} />
                                                            </Form.Group>
                                                        </div>
                                                    </div>
                                                </div>
